...
@section('content')
 ...
 <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <a href="{{ route('visiteur.create') }}" class="ml-4 bg-dark text-white hover:bg-gray-700 text-decoration-none text-xs uppercase   border rounded font-semibold  px-4 py-2 "> <i class="fa fa-plus"></i> ajouter</a>
